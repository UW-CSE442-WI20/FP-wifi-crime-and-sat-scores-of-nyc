...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"party_in_nyc.csv":[function(require,module,exports) {
module.exports = "/party_in_nyc.2d4dfc66.csv";
},{}],"party.js":[function(require,module,exports) {
"use strict";

var _party_in_nyc = _interopRequireDefault(require("./party_in_nyc.csv"));
...
var RAW_CIRCLE_ADJUSTMENT = 4;
var PROCESSED_CIRCLE_ADJUSTMENT = 1.75;
var TEXT_RAW_CIRCLE_DIST = 230;
var SVG_WIDTH = 350;
var SVG_HEIGHT = 800; // Make left side SVG Container

var svg = d3.select("#viz").append("svg").attr("width", 300).attr("height", SVG_HEIGHT).attr("transform", "translate(0,0)"); // todo: try deleting this see if anything changes

var svg2 = d3.select("#viz").append("svg").attr("width", SVG_WIDTH).attr("height", SVG_HEIGHT).attr("id", "right-circles");
var mapping = {
  "BROOKLYN": 0,
  "MANHATTAN": 0,
  "BRONX": 0,
...
d3.csv(_party_in_nyc.default).then(function (data) {
  ...
  svg.selectAll(".labels").data(d3.entries(mapping)).enter().append("text").attr("x", XSTART).attr("y", function (d, i) {
    return i * YSPACING_SCALE + YSPACING_OFFSET;
  }).text(function (d) {
    return d.key;
  });
  var nodes = svg.append("g").attr("class", "nodes").selectAll("circle").data(d3.entries(mapping)).enter() // Add one g element for each data node here.
  ...
  nodes.append("circle").attr("class", "node").attr("r", function (d) {
  ...
  nodes.append("text").attr("text-anchor", "middle").text(function (d) {
    return Math.round(d.value / 1000) + "k";
  });
  var nodes2 = svg2.append("g").attr("class", "nodes").selectAll("circle").data(d3.entries(mapping)).enter() // Add one g element for each data node here.
  .append("g") // Position the g element like the circle element used to be.
  .attr("transform", function (d, i) {
    // Set d.x and d.y here so that other elements can use it. d is 
    // expected to be an object here.
  ...
  nodes2.append("circle").attr("class", "node").attr("r", function (d) {
  ...
  nodes2.append("text").attr("text-anchor", "middle").text(function (d) {
...
},{"babel-core/register":"../node_modules/babel-core/register.js","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./party_in_nyc.csv":"party_in_nyc.csv"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","party.js"], null)
//# sourceMappingURL=/party.41001abd.js.map